        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 border border-[#722F37]">
          <div className="h-full flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              name='name'
              value={name}
                    className="pl-10 pr-4 py-3 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 text-[#722F37] focus:ring-[#722F37] focus:border-[#722F37] transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    name='password'
                    className="pl-10 pr-10 py-3 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 text-[#722F37] focus:ring-[#722F37] focus:border-[#722F37] transition-all"
                  />
                  <div 
